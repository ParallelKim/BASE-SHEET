...
채점 진리를 인쇄에서 읽는 절차는 [docs/chart-verification.md](docs/chart-verification.md). 스튜디오에서 MIDI를 검수하는 방법은 [docs/studio-review.md](docs/studio-review.md). 에이전트는 [AGENTS.md](AGENTS.md). 공유 픽스처 목록은 [tests/fixtures/README.md](tests/fixtures/README.md).
